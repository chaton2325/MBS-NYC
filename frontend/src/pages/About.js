    ...
    <div data-testid="about-page" className="pt-20">
      ...
      >
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12">
          ...
          >
            <span className="text-sm uppercase tracking-widest text-slate-300 font-semibold">About MBS NYC</span>
            <h1
            ...
            <p data-testid="about-description" className="text-lg md:text-xl leading-relaxed text-slate-300">
